...
export function About() {
  return (
    <>
      <div className="bg-gradient-to-r from-sky-600 via-blue-600 to-sky-600 p-4 text-center w-full items-center justify-center flex flex-col text-white py-40 font-serif">
